...
@Service
public class PersonDetailsService implements UserDetailsService {//сервис будет не обычным, а для Spring Security
    //Чтобы нам самим не проводить вручную аутентификацию
